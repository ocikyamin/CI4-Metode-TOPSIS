                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="form-check form-switch">
                                    ...
                                    <input class="range form-check-input" name="range[]" type="checkbox" role="switch"
                                        id="range-<?=$s['id']?>" value="<?=$s['range']?>">
...
$(document).ready(function() {
  ...
  <span role="status"> Isian Nilai Belum Lengkap ..</span>`)
    ...
    $("#anggota").on("change", function() {
        ...
        // Kirim request AJAX untuk mendapatkan data alternatif berdasarkan anggota
        $.ajax({
            ...
            success: function(data) {
                // Setel radio button berdasarkan data yang diterima
                $.each(data, function(index, item) {
                    var kriteria_id = item.kriteria_id;
                    var range_value = item.range;

                    // Setel radio button yang sesuai dengan data
                    $("input[name='range[" + kriteria_id + "]'][value='" +
                        range_value + "']").prop("checked", true);
                });
            },
            error: function() {
