...
//     return 'Besar Pinjaman Maksimal 75 Juta';
// } else {
//     return 'Besar Pinjaman Maksimal 200 Juta';
// }

$tes = hitungBesarPinjaman(0.75);
echo $tes;
    ...
    simpanNilaiMax($k['id'], $maxValues[$k['id']]);
        ...
        foreach ($list_alternatif as $a) {?>
            ...
            $hasil_pangkat_dmin = sqrt($dMinAlternatif);
            $nilai_topsis = $hasil_pangkat_dmin / ($hasil_pangkat_dplus + $hasil_pangkat_dmin);
            $nilai_keputusan = number_format($nilai_topsis, 5);
            $hasil_keputusan = hitungBesarPinjaman($nilai_keputusan);
            $ket = Keputusan($nilai_keputusan);
            
            simpanNilaiTopsis($a['id_anggota'], $nilai_keputusan);
